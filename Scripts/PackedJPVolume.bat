...
move "%lrpath%weiss_data\sys\filelist2v.win32.bin" "%lrpath%weiss_data\dir-1\dir-2\dir-3\filelist2v.win32.bin" > nul
move "%lrpath%weiss_data\sys\white_img2v.win32.bin" "%lrpath%weiss_data\dir-1\dir-2\dir-3\white_img2v.win32.bin" > nul

cd /d "%lrpath%weiss_data\dir-1\dir-2\dir-3"
ff13tool -x -ff133 filelist2v.win32.bin white_img2v.win32.bin

cd /d "%~dp0..\PatchTools\"
copy WPDPack.exe "%lrpath%"weiss_data\dir-1\dir-2\dir-3\white_img2v\db\resident\*.* > nul

cd /d "%lrpath%weiss_data\dir-1\dir-2\dir-3\white_img2v\db\resident"
WPDPack.exe -U wdbpack.bin > nul

cd /d "%~dp0..\PatchTools\"
copy LRVolumePatchTool.exe "%lrpath%"weiss_data\dir-1\dir-2\dir-3\white_img2v\db\resident\wdbpack\*.* > nul

cd /d "%lrpath%weiss_data\dir-1\dir-2\dir-3\white_img2v\db\resident\wdbpack\"
...
move "%lrpath%weiss_data\dir-1\zone\filelist_z0120v.win32.bin" "%lrpath%weiss_data\zone-dir1\zone-dir2\filelist_z0120v.win32.bin" > nul
move "%lrpath%weiss_data\zone\white_z0120v_img.win32.bin" "%lrpath%weiss_data\zone-dir1\zone-dir2\white_z0120v_img.win32.bin" > nul
...
ff13tool -x -ff133 filelist_z0120v.win32.bin white_z0120v_img.win32.bin

cd /d "%~dp0..\PatchTools\"
copy LRVolumePatchTool.exe "%lrpath%weiss_data\zone-dir1\zone-dir2\white_z0120v_img\sound\pack\8000\*.*" > nul

cd /d "%lrpath%weiss_data\zone-dir1\zone-dir2\white_z0120v_img\sound\pack\8000\"
...
cd /d "%lrpath%weiss_data\zone-dir1\zone-dir2\"
ff13tool -c -ff133 filelist_z0120v.win32.bin white_z0120v_img 

cls
echo.
echo Packed z0120v bin file
echo.

move "%lrpath%weiss_data\zone-dir1\zone-dir2\filelist_z0120v.win32.bin" "%lrpath%weiss_data\dir-1\zone\filelist_z0120v.win32.bin" > nul

cd /d "%lrpath%weiss_data\dir-1\dir-2\dir-3\"
ff13tool -c -ff133 filelist2v.win32.bin white_img2v

cls
echo.
echo Packed img2v bin file
echo.

move "%lrpath%weiss_data\dir-1\dir-2\dir-3\filelist2v.win32.bin" "%lrpath%weiss_data\sys\filelist2v.win32.bin" > nul
move "%lrpath%weiss_data\dir-1\dir-2\dir-3\white_img2v.win32.bin" "%lrpath%weiss_data\sys\white_img2v.win32.bin" > nul
move "%lrpath%weiss_data\zone-dir1\zone-dir2\white_z0120v_img.win32.bin" "%lrpath%weiss_data\zone\white_z0120v_img.win32.bin" > nul
